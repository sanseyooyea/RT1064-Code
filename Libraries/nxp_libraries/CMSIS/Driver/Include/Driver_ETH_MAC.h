...
typedef struct _ARM_DRIVER_ETH_MAC {
    ARM_DRIVER_VERSION (*GetVersion)(
            void);                                                ///< Pointer to \ref ARM_ETH_MAC_GetVersion : Get driver version.
    ...
    int32_t (*Uninitialize)(
            void);                                                ///< Pointer to \ref ARM_ETH_MAC_Uninitialize : De-initialize Ethernet MAC Device.
    ...
    int32_t (*SendFrame)(const uint8_t *frame, uint32_t len,
